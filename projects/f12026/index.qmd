...
```{=html}
<div id="streamline-ver-explorer" style="text-align: center; background: #f8f9fa; padding: 20px; border-radius: 12px; margin-bottom: 30px;">
  <img id="sliderImageVer" src="images/slices_streamHor/opt_2stream_hor.0001.jpeg" style="width:100%; max-width:900px; border-radius: 5px;">
  ...
  <script>
    (function() {
      ...
      sliderVer.addEventListener('input', function() {
        const frameName = this.value.toString().padStart(4, '0');
        imgDisplayVer.src = `images/slices_streamHor/opt_2stream_hor.${frameName}.jpeg`;
      });
    })();
  </script>
</div>
