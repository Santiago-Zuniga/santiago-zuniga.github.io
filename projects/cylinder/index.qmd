...
To mitigate the detrimental effects of Vortex-Induced Vibrations, passive flow control devices are often employed in offshore and structural engineering. Inspired by the experimental and numerical investigations by Korkischko & Meneghini (2010), a new simulation was configured to evaluate the effectiveness of helicoidal strakes in suppressing these self-sustaining oscillations.

The modified geometry consists of a cylinder fitted with three helicoidal strakes arranged at 120-degree intervals. Strakes function by breaking the spanwise correlation of the vortex shedding. Instead of forming a strong, synchronized von Kármán vortex street, the fluid separates at varying phases along the span of the cylinder. This three-dimensional flow disruption prevents the vortices from shedding uniformly along the length of the body, which significantly reduces the net fluctuating lift forces acting on the structure.

::: {#fig-helix-geometry layout-align="center"}
![Geometry of the cylinder showing the implementation of three helicoidal strakes at 120 degrees.](images/helix.png)
:::
